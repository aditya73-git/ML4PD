...
CHECKERBOARD = (10, 7)
SQUARE_SIZE_CM = 1.5
IMAGE_DIR = "C:/Users/LEGION7/OneDrive/Desktop/PERSONAL/TUM/Semester 1/Machine Learning for Product Development/ML4PD/Location Tracking/Checkerboard_frames_cam1"
IMAGE_EXT = "*.jpg"
STEP = 5
...
if len(imgpoints) >= 10:
    ...
    np.savez("cam1_calib.npz", mtx=mtx, dist=dist)
else:
