...
img = cv2.imread("C:/Users/LEGION7/OneDrive/Desktop/PERSONAL/TUM/Semester 1/Machine Learning for Product Development/ML4PD/Location Tracking/TragetFrame_cam2/frame_00006.jpg")
if img is None:
...
np.save("cam2_homography_prezoom.npy", H2)
